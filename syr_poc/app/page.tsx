      ...
      <main className="flex flex-col">
        <section className="flex flex-col mb-8">
          <div className="relative border rounded-lg overflow-hidden w-full aspect-square sm:aspect-video md:aspect-[32/9] my-3">
            ...
            />
            <div className="absolute top-0 w-full h-full bg-[linear-gradient(transparent_0%,rgb(156,35,16)_200%)]"/>
          ...
          <div className="p-5 border rounded-lg overflow-hidden w-full h-fit my-3">
          ...
          <div className="relative border rounded-lg overflow-hidden w-full md:aspect-[32/9] my-3">
            <Image
              src={'/vanlifers.jpg'}
              height={1500}
              width={1500}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 p-5 border rounded-lg overflow-hidden w-full my-3 bg-macaroni-and-cheese-200">
            <div className="relative w-full aspect-video">
              <div className="absolute w-[400%] -top-[620%] -left-[160%] sm:w-[200%] sm:-top-[90%] sm:-left-[105%] aspect-square rounded-full overflow-hidden">
                <Image
                  src={'/backpacker-2.jpg'}
                  height={1500}
                  width={1500}
                  alt='backpacker-2'
                  className="absolute w-[40%] h-[50%] -bottom-[20%] left-[30%] sm:left-[20%] sm:bottom-[0%] md:bottom-[0%] sm:w-full sm:h-full object-cover"
                />
                <div className="absolute top-0 w-full h-full bg-[linear-gradient(transparent_0%,rgb(156,35,16)_300%)]"/>
              </div>
            </div>
            <div className="m-auto">
              ...
              <ul className="text-lg md:text-xl font-extrabold text-macaroni-and-cheese-600 pl-3">
                <li>- Meetings: Connect with fellow travelers for enriching encounters.</li>
                <li>- Trips: Plan and embark on journeys together.</li>
                <li>- Co-sleeping: Find and share accommodations for a more immersive experience.</li>
              </ul>
              <p className="text-lg md:text-xl font-extrabold text-macaroni-and-cheese-950 text-pretty">
          ...
          <Card className="flex flex-col sm:flex-row overflow-hidden m-auto my-3 bg-macaroni-and-cheese-50 text-macaroni-and-cheese-950">
            ...
            <div className="flex flex-col">
              <CardHeader className="pb-2 pl-6 sm:pl-0 pt-0 sm:pt-6">
                ...
                <CardDescription className="text-macaroni-and-cheese-600">
